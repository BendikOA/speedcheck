...
<style>
  ...
  .rank       { color: var(--gb-low-contrast); font-size: 0.8rem; width: 2rem; }
  .final-speed { font-weight: 700; font-variant-numeric: tabular-nums; font-size: 1rem; color: var(--success); }
  .boost-label { font-size: 0.82rem; color: var(--gb-low-contrast); white-space: nowrap; }
  .base        { font-variant-numeric: tabular-nums; color: var(--gb-low-contrast); }
  .nature      { font-size: 0.8rem; white-space: nowrap; }
  .nature-pos  { color: var(--accent-2); }
  .nature-neu  { color: var(--gb-low-contrast); }
  .notes       { font-size: 0.82rem; color: var(--gb-low-contrast); white-space: nowrap; }
  .pokemon-list {
    font-size: 0.82rem;
    color: var(--gb-low-contrast);
    max-width: 320px;
